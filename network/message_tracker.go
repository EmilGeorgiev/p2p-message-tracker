...
// MessageTracker tracks a configurable fixed amount of messages. Messages are stored
// first-in-first-out. Duplicate messages should not be stored in the queue.
